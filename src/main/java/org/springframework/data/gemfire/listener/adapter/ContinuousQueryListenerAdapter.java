 ...
 *    void handleMessage(CqEvent event);
 *    void handleMessage(Operation op);
 *    void handleMessage(Object key);
 *    void handleMessage(Object key, Object newValue);
 *    void handleMessage(Throwable th);
 *    void handleMessage(CqEvent event, Operation op, byte[] deltaValue);
 * }</pre>
 *
