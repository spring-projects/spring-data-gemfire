...
public class AbstractGemFireAsLastResourceAspectSupport implements Ordered {
	...
	protected static final Consumer<String> NO_OP_LOGGER = new Consumer<String>() {
		@Override
	 ...
	 */
	protected <T extends AbstractGemFireAsLastResourceAspectSupport> T logTraceInfo(final String message,
			final Object... args) {

		return logTraceInfo(new Supplier<String>() {
			@Override
			public String get() {
	...
	protected static class GemFireConnectionHolder {
		...
		private static final ThreadLocal<GFConnection> gemfireConnection = new ThreadLocal<GFConnection>();
		...
		/* (non-Javadoc) */
		public static GFConnection get() {
			return gemfireConnection.get();
		}
