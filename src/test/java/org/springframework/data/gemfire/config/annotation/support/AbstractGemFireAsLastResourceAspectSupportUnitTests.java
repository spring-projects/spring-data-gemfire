...
public class AbstractGemFireAsLastResourceAspectSupportUnitTests {
	...
	public void logTraceInfoUsingMessageSupplierWhenTracingIsEnabled() {
		...
		assertThat(aspectSupport.logTraceInfo(
			new AbstractGemFireAsLastResourceAspectSupport.Supplier<String>() {
				@Override
				public String get() {
					return "trace test message with Supplier";
				}
			})).isSameAs(aspectSupport);
	...
	public void resolveContextReturnsNewInitialContext() throws NamingException {
		...
		Hashtable<String, Object> mockEnvironment = new Hashtable<String, Object>();
	...
	public void resolveContextHandlesNamingExceptionAndThrowsIllegalStateException() throws NamingException {
		...
		Hashtable<String, Object> testEnvironment = new Hashtable<String, Object>();
	...
	protected static final class VariableArgumentMatcher<T> extends ArgumentMatcher<T> implements VarargMatcher {

		protected static Object[] varArgThat(Object... expectedArguments) {
			return argThat(new VariableArgumentMatcher<Object[]>(expectedArguments));
		}
		...
		protected VariableArgumentMatcher(Object... expectedArguments) {
			...
			Assert.notNull(expectedArguments, "Expected arguments must not be null");
		...
		@Override
		@SuppressWarnings("unchecked")
		public boolean matches(Object actualArgument) {
